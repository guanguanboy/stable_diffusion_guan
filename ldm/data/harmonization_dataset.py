...
class HarmonizationTrain(HarmonizationBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/mnt/lustre/zhaobin/liguanlin/datasets/iHarmony/HAdobe5k_256/composite_images_train/", sub_dir='composite_images_train', **kwargs)

class HarmonizationValidation(HarmonizationBase):
    def __init__(self, **kwargs):
        super().__init__(data_root="/mnt/lustre/zhaobin/liguanlin/datasets/iHarmony/HAdobe5k_256/composite_images_test/", sub_dir='composite_images_test', **kwargs)
