...
if __name__ == '__main__':
    ...
    output_path = '/data1/liguanlin/research_projects/DPM/stable-diffusion/outputs/harmonization-samples/'
    ...
    with open(files,'r') as f:
            for line in f.readlines():
                ...
                harmonized_img_name = name_str
                harmonized_path = os.path.join(output_path, harmonized_img_name)

                name_parts=name_str.split('_')
                target_name = name_str.replace(('_'+name_parts[-2]+'_'+name_parts[-1]),'.jpg')
                real_path = '/data1/liguanlin/Datasets/iHarmony/Hday2night/real_images/' + target_name
